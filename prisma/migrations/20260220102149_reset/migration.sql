...
CREATE TABLE "pensortiran" (
    ...
    CONSTRAINT "pensortiran_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "pensortiran_items" (
    "id" BIGSERIAL NOT NULL,
    "pensortiran_id" BIGINT NOT NULL,
    "nama" TEXT NOT NULL,
    "qty" DECIMAL(14,4) NOT NULL,
    "upah_per_kg" DECIMAL(14,2) NOT NULL,
    "total" DECIMAL(14,2) NOT NULL,

    CONSTRAINT "pensortiran_items_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "pengemasan_items" ADD CONSTRAINT "pengemasan_items_item_type_id_fkey" FOREIGN KEY ("item_type_id") REFERENCES "item_types"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "pensortiran_items" ADD CONSTRAINT "pensortiran_items_pensortiran_id_fkey" FOREIGN KEY ("pensortiran_id") REFERENCES "pensortiran"("id") ON DELETE CASCADE ON UPDATE CASCADE;
