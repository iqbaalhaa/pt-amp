		...
		<div className="min-h-screen flex w-full">
			...
			<div className="hidden lg:flex w-1/2 bg-zinc-900 relative overflow-hidden items-center justify-center">
				...
				<div className="relative z-10 max-w-lg px-12 text-center text-white">
					...
					<h2 className="text-4xl font-bold mb-6">PT Alam Maju Perkasa</h2>
					<p className="text-lg text-white/80 leading-relaxed">
						Platform manajemen terintegrasi untuk operasional dan distribusi hasil bumi berkualitas tinggi.
					</p>
					
					<div className="mt-12 grid grid-cols-2 gap-6 text-left">
						<div className="p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10">
							<div className="text-2xl font-bold mb-1">100%</div>
							<div className="text-sm text-white/60">Aman & Terpercaya</div>
						</div>
						<div className="p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10">
							<div className="text-2xl font-bold mb-1">24/7</div>
							<div className="text-sm text-white/60">Sistem Monitoring</div>
						</div>
					</div>
				</div>
