    ...
    <>
      ...
      >
        ...
        <div className="relative aspect-[4/3] bg-zinc-100 overflow-hidden">
          ...
          <div className="fallback-icon hidden absolute inset-0 flex items-center justify-center bg-zinc-200 text-zinc-300 z-0 pointer-events-none">
            <ImageIcon size={48} opacity={0.5} />
          </div>
                      ...
                      {isInfoExpanded && (
                        ...
                        >
                          ...
                          <div className="space-y-1.5">
                            ...
                            <label
                              className={`w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg cursor-pointer transition-all border ${
                                hasCoverFile
                            ...
                            >
                              <div
                                className={`p-1 rounded-full ${
                                  hasCoverFile ? "bg-red-100" : "bg-zinc-100"
                                }`}
                              >
                                {hasCoverFile ? (
                      ...
                      <form
                        ...
                        action={async (formData) => {
                          ...
                          try {
                            ...
                            alert(
                              "Gagal mengupload media. Pastikan file tidak terlalu besar."
                            );
                          } finally {
                      ...
                      >
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="flex gap-2">
                            <label
                              className={`w-full flex items-center justify-center gap-2 px-4 py-2 rounded-lg cursor-pointer transition-all border ${
                                hasFile
                                  ? "bg-red-50 border-red-200 text-red-700"
          ...
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            <div className="bg-white rounded-xl shadow-2xl p-6 max-w-sm w-full space-y-4 relative z-10 animate-in fade-in zoom-in-95 duration-200">
              ...
              <p className="text-sm text-zinc-600">
                Tindakan ini permanen. Semua media di dalam album ini akan ikut
                terhapus.
              </p>
        ...
        {item.type === "video" ? (
          ...
          <img
            ...
            onError={(e) => {
              ...
              icon.innerHTML =
                '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-zinc-400"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg>';
      ...
      {isEditing && (
        <div className="absolute inset-0 z-10 bg-white p-3 flex flex-col gap-2 animate-in fade-in duration-200">
          ...
          >
            ...
            <button className="mt-auto w-full bg-zinc-900 text-white text-[10px] py-1 rounded">
              Simpan
            </button>
          </form>
        </div>
