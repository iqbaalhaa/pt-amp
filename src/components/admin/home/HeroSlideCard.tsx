              ...
              <div className="w-full h-full flex items-center justify-center bg-zinc-900 relative">
                <video
                  ...
                  onError={(e) => {
                    ...
                    e.currentTarget.parentElement?.classList.add("bg-zinc-800"); // Darker fallback for video
                    const fallback =
                ...
                />
                <div className="video-fallback-icon hidden absolute inset-0 flex items-center justify-center text-zinc-500">
          ...
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-sm text-zinc-500 mb-6">
                Tindakan ini tidak dapat dibatalkan. Slide akan dihapus
                permanen.
              </p>
