              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-100 bg-white z-10">
                <div>
                  ...
                  <p className="text-xs text-zinc-500">
                    Update konten dan tombol slide ini.
                  </p>
                </div>
                    ...
                    <div className="bg-white p-5 rounded-xl border border-zinc-200 shadow-sm space-y-4">
                      ...
                      <form
                        onSubmit={(e) => {
                          ...
                          setConfirmConfig({
                            title: "Simpan Perubahan Slide?",
                            content:
                              "Apakah Anda yakin ingin menyimpan perubahan pada slide ini?",
                            confirmText: "Simpan",
                            variant: "primary",
                            action: async () => {
                              await updateHeroSlide(slide.id, formData);
                              // setIsOpen(false); // Optional: close modal on success
                            },
                          });
                        }}
                        className="space-y-4"
                    ...
                    <div className="bg-white p-5 rounded-xl border border-zinc-200 shadow-sm space-y-4">
                      ...
                      <div className="space-y-3">
                        {slide.buttons.map((btn) => (
                          <div
                            key={btn.id}
                            className="flex flex-col gap-2 p-3 bg-zinc-50 border border-zinc-100 rounded-lg"
                          >
                            <form
                              onSubmit={(e) => {
                                e.preventDefault();
                                ...
                                setConfirmConfig({
                                  title: "Simpan Tombol?",
                                  content: `Apakah Anda yakin ingin menyimpan perubahan pada tombol ini?`,
                                  confirmText: "Simpan",
                                  variant: "primary",
                                  action: async () => {
                            ...
                            >
                              ...
                              <div className="flex gap-2">
                                ...
                                <button
                                  type="submit"
                                  className="px-3 py-1.5 bg-zinc-200 hover:bg-zinc-300 text-zinc-700 text-xs font-medium rounded"
                                >
                                  Save
                                </button>
                                <button
                                  ...
                                  onClick={() =>
                                    setConfirmConfig({
                                      title: "Hapus Tombol?",
                                      content:
                                        "Tombol ini akan dihapus secara permanen.",
                                      confirmText: "Hapus",
                                      variant: "danger",
                                      action: async () => {
                          ...
                          <form
                            onSubmit={(e) => {
                              ...
                              setConfirmConfig({
                                title: "Tambah Tombol?",
                                content:
                                  "Apakah Anda yakin ingin menambahkan tombol baru ini?",
                                confirmText: "Tambah",
                                variant: "primary",
                                action: async () => {
                          ...
                          >
                            <div className="flex gap-2">
                              <input
                                name="text"
                                placeholder="Label"
                                className="flex-1 px-2 py-1.5 text-xs border border-zinc-200 rounded"
                                required
                              />
                              <select
                                name="isPrimary"
                                className="px-2 py-1.5 text-xs border border-zinc-200 rounded"
                              >
                                <option value="true">Primary</option>
                                <option value="false">Secondary</option>
                              </select>
                            ...
                            <div className="flex gap-2">
                              ...
                              <button
                                type="submit"
                                className="px-3 py-1.5 bg-zinc-900 text-white text-xs font-medium rounded hover:bg-zinc-800"
                              >
                                <Plus size={14} /> Add
                              </button>
                            </div>
