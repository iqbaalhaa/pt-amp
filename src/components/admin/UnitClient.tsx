...
export default function UnitClient({ initialUnits }: UnitClientProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    openConfirm({
      title: editingUnit ? "Simpan Perubahan" : "Simpan Satuan",
      message: editingUnit
        ? "Apakah Anda yakin ingin menyimpan perubahan pada satuan ini?"
        : "Apakah Anda yakin ingin menambahkan satuan baru?",
      variant: "primary",
      confirmText: "Simpan",
      onConfirm: async () => {
