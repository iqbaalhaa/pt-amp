          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center mb-24">
            <div className="order-2 md:order-1">
              <h2 className="text-3xl font-bold mb-6 text-zinc-900">
                {aboutPage?.mainTitle || "Siapa Kami?"}
              </h2>
                ...
                {aboutPage?.points && aboutPage.points.length > 0 ? (
                  ...
                  <>
                    <div className="flex items-center gap-3">
                      <CheckCircle2 className="w-5 h-5 text-[var(--brand)]" />
                      <span className="text-zinc-700 font-medium">
                        Sumber langsung dari petani lokal
                      </span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle2 className="w-5 h-5 text-[var(--brand)]" />
                      <span className="text-zinc-700 font-medium">
                        Proses sortasi dan grading ketat
                      </span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle2 className="w-5 h-5 text-[var(--brand)]" />
                      <span className="text-zinc-700 font-medium">
                        Kapasitas suplai stabil
                      </span>
                    </div>
                  </>
                )}
            ...
            <AboutMainImage image={aboutPage?.mainImage} />
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {featureCards.length > 0 ? (
              featureCards.map((card) => (
                <div
                  key={card.id}
                  className="bg-zinc-50 rounded-2xl p-8 border border-zinc-100 hover:border-[var(--brand)]/30 transition-colors"
                >
              ...
              <>
                <div className="bg-zinc-50 rounded-2xl p-8 border border-zinc-100 hover:border-[var(--brand)]/30 transition-colors">
                  ...
                  <p className="text-zinc-600 leading-relaxed">
                    Kami membangun hubungan jangka panjang dengan petani.
                    Transparansi penimbangan dan pembayaran yang adil adalah
                    prioritas kami untuk menjaga keberlanjutan pasokan bahan
                    baku.
                  </p>
                </div>
                ...
                <div className="bg-zinc-50 rounded-2xl p-8 border border-zinc-100 hover:border-[var(--brand)]/30 transition-colors">
                  ...
                  <p className="text-zinc-600 leading-relaxed">
                    Setiap batang kulit manis melalui tahap pembersihan,
                    pengikisan kulit luar (scraping), dan penjemuran intensif
                    untuk mencapai kadar air ideal sebelum dikemas.
                  </p>
                </div>
                ...
                <div className="bg-zinc-50 rounded-2xl p-8 border border-zinc-100 hover:border-[var(--brand)]/30 transition-colors">
                  ...
                  <p className="text-zinc-600 leading-relaxed">
                    Produk kami dikemas dalam ball press 40–60 kg yang efisien
                    untuk pengiriman. Kami melayani kebutuhan industri bumbu,
                    ekstrak, dan eksportir rempah.
                  </p>
                </div>
              </>
            )}
