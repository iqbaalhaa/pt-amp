...
export function HeroCarousel({ slides }: HeroCarouselProps) {
  ...
  if (!slides || slides.length === 0) {
    return (
      <div className="relative overflow-hidden min-h-[500px] flex items-center bg-gradient-to-b from-zinc-50 via-white to-zinc-50 border-b border-zinc-200">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="text-lg text-zinc-600 mb-8 leading-relaxed max-w-lg">
                Pengolahan dan distribusi kulit manis dengan standar mutu terbaik.
              </p>
            </div>
